# Generated by Django 2.0.13 on 2019-09-18 19:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lan', models.ManyToManyField(blank=True, to='app.LanguagePerson')),
        ...
        migrations.AddField(
            model_name='person',
            name='type',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.TypePerson'),
        ),
        migrations.AddField(
            model_name='mail',
            name='per',
